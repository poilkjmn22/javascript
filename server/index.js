...
//RESTFUL API
const navList = require("./routes/nav-list.js");
const bugRecord = require("./routes/bug-record.js");
const noteCateList = require("./routes/note-cate-list.js");

app.get("/api/nav-list/list", navList.list);
app.post("/api/nav-list/add", navList.add);
app.post("/api/nav-list/delete", navList.delete);
