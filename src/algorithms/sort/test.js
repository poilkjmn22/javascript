...
for (const n of nTimes(20)) {
  sortBucketSample.push(round(Math.random(), 3));
}
console.log(sortBucketSample);
console.log(sortBucket(sortBucketSample));

console.log(sortMerge([15, 9, 8, 1, 4, 11, 7, 12, 13, 6, 5, 3, 16, 2, 10, 14]));
console.log(sortMerge([7,6,5,4,3,2,1]));
console.log(sortMerge('mergesort'));
