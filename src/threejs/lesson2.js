 ...
 * @LastEditors: fangqi
 * @LastEditTime: 2021-12-17 10:42:42
...
function init(elContainer) {
    ...
    var camera = new THREE.PerspectiveCamera(45, elContainer.clientWidth / elContainer.clientHeight, 0.1, 100);
...
function init_custom_geom(elContainer) {
  ...
  const material = new THREE.MeshLambertMaterial({opacity: 0.6, color: 0x44ff44, transparent: true})
  ...
  var controls = new function () {
      ...
      this.switchCamera = function () {
          if (camera instanceof THREE.PerspectiveCamera) {
              // 正交投影摄像机
              camera = new THREE.OrthographicCamera(elContainer.clientWidth / -16, elContainer.clientWidth / 16, elContainer.clientHeight / 16, elContainer.clientHeight / -16, -200, 500);
              camera.position.x = 120;
              camera.position.y = 60;
              camera.position.z = 180;
              camera.lookAt(scene.position);
              ...
              // 透视投影摄像机
              camera = new THREE.PerspectiveCamera(45, elContainer.clientWidth / elContainer.clientHeight, 0.1, 1000);
              camera.position.x = 120;
              camera.position.y = 60;
              camera.position.z = 180;
