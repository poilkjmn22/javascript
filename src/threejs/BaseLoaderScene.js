...
import { initStats, initRenderer, initTrackballControls } from "./util.js";
export default function BaseLoaderScene(
  elContainer,
  providedCamera,
  shouldAddLights,
  shouldRotate,
  ...
  this.stats = initStats(elContainer);
  ...
  this.renderer = initRenderer(elContainer, {
    antialias: true,
  });
